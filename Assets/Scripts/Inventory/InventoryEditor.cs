...
public class InventoryItemEditor : EditorWindow {
    ...
    public InventoryItemsList inventoryItemList;
    ...
    void  OnEnable () {
        if(EditorPrefs.HasKey("ObjectPath")) 
        {
            ...
            inventoryItemList = AssetDatabase.LoadAssetAtPath (objectPath, typeof(InventoryItemsList)) as InventoryItemsList;
        }
    ...
    void OpenItemList () 
    {
        ...
        if (absPath.StartsWith(Application.dataPath)) 
        {
            ...
            inventoryItemList = AssetDatabase.LoadAssetAtPath (relPath, typeof(InventoryItemsList)) as InventoryItemsList;
            if (inventoryItemList.itemList == null)
                inventoryItemList.itemList = new List<InventoryItem>();
            if (inventoryItemList) {
                EditorPrefs.SetString("ObjectPath", relPath);
